...
public class UI {
    ...
    public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {
        ...
        printMoves(chessMatch.getChessLog());
    ...
    public static void printMoves(ChessLog log) {
        List<Move> moves = log.getMoves();
        ...
        for (int i = 0; i < moves.size(); i += 2) {
            ...
            String blackMove = (i + 1 < moves.size())
                    ? moves.get(i + 1).getSanAnnotation()
                    : "";

            System.out.printf("%d. %s %s%n", turn, whiteMove, blackMove);
        }
